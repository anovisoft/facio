...
Правило: не прыгать через шаг без явной причины. Шаги 0–5 приняты (5 на минималках). Дальше — волны **В1–В3** (принят PO, 2026-08-20): рот → неделя/пауза локально → база и облако. **В1.0–В1.1 готовы.** Дальше **В1.2**. RFC не переписывать.
...
Принят PO 2026-08-20. Ведёт **PM**; субагенты — разработчики, скилы по `AGENTS.md`. **В1.0–В1.1 готовы.** Дальше **В1.2**. Не прыгать в В1.3+ и не в В2/В3.
