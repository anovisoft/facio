...
Правило: не прыгать через шаг без явной причины. Шаги 0–5 приняты (5 на минималках). Дальше — волны **В1–В3** (принят PO, 2026-08-20): рот → неделя/пауза локально → база и облако. **В1.0–В1.4 готовы; В1.4 принят PO** (микро UI — парковка). Дальше **В1.5**. RFC не переписывать.
...
Принят PO 2026-08-20. Ведёт **PM**; субагенты — разработчики, скилы по `AGENTS.md`. **В1.0–В1.4 готовы. В1.4 принят PO** (2026-08-20 вечер, scripted на симуляторе; микро UI — парковка). Дальше **В1.5**. Не прыгать в В2/В3.
...
**Статус: не начат.** `pytest -m live` без ключа skip; с ключом — инварианты В1.2, не дословный текст. Провал — промпт/провайдер, не набор имён. Не прыгать в В2.
