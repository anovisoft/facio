...
**Статус: принят по механике.** UI: стекло, теминг, клик, кнопки Use; четвёртый проход — галочка на крышке, градиент, первый запуск. Ждёт dogfood PO. Не считать шаг 1 закрытым для витрины, пока крышку не стыдно поставить первым кадром.
