...
**Статус: принят** (PO, 2026-08-16). Посев и старый стол получают велосипед. Плитка-ряд 4×2, Use, локальный пуш из `ReminderClock`, час на Use: чип → sheet (колёса час/минута + Сохранить). Тап пуша открывает крышку. Шаг 3 не начинать, пока PO не скажет.
