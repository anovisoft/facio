...
Правило: не прыгать через шаг без явной причины. Шаги 0–5 приняты (5 на минималках). Дальше — волны **В1–В3** (принят PO, 2026-08-20): рот → неделя/пауза локально → база и облако. **В1.0–В1.4 готовы; В1.4 принят PO** (микро UI — парковка). **В1.5 harness готов** (live 3/8). RFC не переписывать.
...
Принят PO 2026-08-20. Ведёт **PM**; субагенты — разработчики, скилы по `AGENTS.md`. **В1.0–В1.4 готовы. В1.4 принят PO** (микро UI — парковка). **В1.5 harness готов**; live 3/8 — промпт ещё не крутили. Не прыгать в В2/В3.
...
Дальше в В1: ужесточить промпт/провайдер (отдельный контракт). Не В2.
