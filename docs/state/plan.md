...
**PO, вечер 2026-08-19.** Текущий концепт крышки/шторки принят как опробованная гипотеза («выглядит удобно»). Не полир. Следующее — описать шаги к RFC-like рту (модель через MCP/tools, функционал может быть неполным). Не синк, не голос, не готовка, пока PO не скажет.
