...
**Статус: принят.** `apps/mobile-swiftui`. Закон гоняет `packages/domain/fixtures`. Посев на Сегодня, не в Lifetime. Подсказка на плитке: «держи корпус и ягодицы». Склад: `desk.json` + `journal.jsonl`. Use без карусели.
