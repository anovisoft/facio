...
**Статус: принят** (PO, 2026-08-16). Карточка на Сегодня, чипы только вниз. Посев без живой активности велосипеда: 21 день тишины, плитка в Lifetime, пока карточка жива. Чипы: высота 32, ширина по тексту до 152, многоточие, перенос ряда. Дельта-утро (`unanswered_morning`) и утренний пуш не делались — нет часа в RFC. Шаг 4 не начинать, пока PO не скажет.
