...
## Slice E2b-iterate — Manual entry + checklist polish (#11–13)

**Goal:** Fix Create answer field; put Edit on the Block (not session-global); calm checklist reorder.
...
**PO dogfood:** Type in clarify field → text sits correctly; on plan/Session checklist see Edit+pencil → edit that list; reorder without jerks/leftover outline.
